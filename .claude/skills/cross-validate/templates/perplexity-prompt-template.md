...
results que Sonar básico, líder SimpleQA factuality F=0.858. Verificado
abril 2026 — Sonar Pro mitiga la debilidad histórica de circular
keyword citations.
...
- **URL-or-it-didn't-happen para claims competitivos.** Cualquier
  ...
  satura en LATAM" debe traer URL al post/canal específico + fecha.
...
- **Adaptación por mercado.** Si el input apunta a LATAM, buscá en
  español. Si apunta a global, buscá en ambos idiomas.
- **Date-anchor cada source.** "Cited 2026-04-24, page updated
  2026-03-12" o similar — sin fecha, el sintetizador no puede pesar
