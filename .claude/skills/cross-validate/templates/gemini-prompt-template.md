...
#1 GPQA Diamond (94.3%, líder reasoning), #1 ARC-AGI-2 (77.1%,
abstract reasoning), #1 MMMU-Pro (multimodal reasoning), three-tier
thinking system. Verificado 2026-04-24 contra benchmarks oficiales.
Aplicación a este task: detectás cuando una decisión "suena bien"
pero estructuralmente no se sostiene cuando seguís la lógica
end-to-end.
