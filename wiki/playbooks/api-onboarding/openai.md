...
layer: wiki
language: es
tags: [capa/2-wiki, api, openai, cross-validate, onboarding]
updated: 2026-04-24
confidence: high
source_count: 4
...
- Cargá exactamente lo que querés gastar máximo (ej. $10) y
  **desactivá auto-recharge**. Cuando el saldo se agota, el skill
...
Estado al 2026-04-24 (verificar [platform.openai.com/docs/models](https://platform.openai.com/docs/models)
...
template: $4 USD para OpenAI dentro de un cap total de $10 split entre
los 3 proveedores externos; ajustá según tu uso real).
...
- El costo exacto depende del modelo seleccionado.
- Cross-validate hace ~1 request por idea validada, costo típico
  $0.50-$1.00 por idea con `gpt-5.4` a precios actuales.
