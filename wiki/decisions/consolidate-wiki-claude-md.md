...
layer: wiki
language: en
tags: [decision, framework, governance, capa/2-wiki]
updated: 2026-04-13
...
**What it affects:** `wiki/CLAUDE.md` (expanded with subfolder table), 7 subfolder CLAUDE.md files (deleted). Main repo went from 17 to 10 CLAUDE.md files.
